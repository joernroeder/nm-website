...
define(['jquery', 'underscore', 'backbone', 'handlebars', 'layoutmanager', 'plugins/backbone.JJRelational', 'plugins/backbone.JJRestApi', 'responsiveimage/picturefill'], function($, _, Backbone, Handlebars) {
  var JST, app;
  app = {
    root: '/',
    pendingTemplateReqs: {}
