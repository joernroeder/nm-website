...
define(['app', 'modules/DataRetrieval', 'plugins/misc/spin.min', 'plugins/editor/jquery.jjdropzone', 'plugins/editor/jquery.jjmarkdown'], function(app, DataRetrieval, Spinner) {
  "use strict";
  var UserSidebar;
