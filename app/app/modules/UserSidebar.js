...
define(['app', 'modules/DataRetrieval', 'plugins/misc/spin.min', 'plugins/editor/jquery.jjdropzone'], function(app, DataRetrieval, Spinner) {
  "use strict";
  var UserSidebar, sidebarSpinnerOpts;
  ...
  UserSidebar.Views.Main = Backbone.View.extend({
    ...
    initSpinner: function() {
      ...
      console.log($('#editor-sidebar-spinner', this.$el)[0]);
      this.spinner = {
        inst: new Spinner(sidebarSpinnerOpts),
        target: $('#editor-sidebar-spinner', this.$el)[0]
      };
      return console.log(this.spinner);
    },
