...
define(['app', 'modules/DataRetrieval', 'modules/RecycleBin', 'plugins/misc/spin.min', 'plugins/editor/jquery.jjdropzone', 'plugins/editor/jquery.jjmarkdown'], function(app, DataRetrieval, RecycleBin, Spinner) {
  "use strict";
  var UserSidebar;
