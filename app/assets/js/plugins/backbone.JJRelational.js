  ...
  Backbone.JJRelationalModel = Backbone.Model.extend({
    ...
    save: function(key, value, options) {
      ...
      actualSave = function() {
        ...
        options.success = function(resp, status, xhr) {
          ...
          serverAttrs = _this.parse(resp, xhr);
          if (options.wait) {
    ...
    */
    ...
    set: function(key, val, options) {
      var attrs, ignoreChanges, now, relation, silent, unset, v, value, _i, _len;
          ...
          if (relation.collectionType && (collType = Backbone.JJRelational.__getCollectionType(relation.collectionType))) {
            ...
            for (_i = 0, _len = resp.length; _i < _len; _i++) {
              ...
              if (_.isObject(respObj)) {
                parsedObjs.push(relModel.prototype.parse(respObj, xhr));
              }
            }
          }
  ...
  */
  ...
  Backbone.Collection.prototype.fetch = function(options) {
    ...
    options.success = function(resp, status, xhr) {
      ...
      parsedResp = _this.parse(resp, xhr);
      existingModels = [];
      args = [];
  ...
  Backbone.Collection.prototype.fetchByIdQueue = function(options) {
    ...
    if (idQueue.length > 0) {
      ...
      options.success = function(resp, status, xhr) {
        ...
        _this.add(_this.parse(resp, xhr), options);
        if (success) {
          return success(_this, resp);
        }
      };
