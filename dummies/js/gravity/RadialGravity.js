...
"use strict";
var RadialGravity, b2Body, b2BodyDef, b2CircleShape, b2DebugDraw, b2EdgeShape, b2Fixture, b2FixtureDef, b2PolygonShape, b2Settings, b2Vec, b2World;
...
RadialGravity = (function() {
  ...
  */
  ...
  function RadialGravity(intervalRate, adaptive) {
    ...
    this.fixDef = function() {
      ...
      fix.shape.SetAsBox(this.width / this.scale() / 2, this.height / this.scale() / 2);
  ...
  */
  ...
  RadialGravity.hasBorders = false;

  RadialGravity.prototype.setDimensions = function(width, height) {
    var borderWidth, borders, createBorder, createBorders, updateBorders,
      _this = this;
  ...
  */
  ...
  RadialGravity.prototype.setGravity = function(gravity) {
    this.gravityPosition = new b2Vec(1, 1);
